...
const getReset = () => ({
    'html, body, div, span, .applet, object, iframe, h1, h2, h3, h4, h5, h6, p, blockquote, pre, a, abbr, address, cite, code, del, dfn, em, img, ins, kbd, q, s, samp, small, strong, sub, sup, .tt, var, b, u, i, dl, dt, dd, ol, ul, li, fieldset, form, label, legend, table, caption, tbody, tfoot, thead, tr, th, td, article, aside, canvas, details, embed, figure, figcaption, footer, header, hgroup, menu, nav, output, ruby, section, summary, time, mark, audio, video': {
        margin: 0,
        padding: 0,
        border: 0,
        fontSize: 'inherit',
...
const getFontFace = theme => {
    const fontFaces = lodash_2(theme, 'typography.fontFaces', lodash_2(theme, 'typography.fontFace', {}));
    const properties = [];
    lodash_4(fontFaces, (value, key) => {
...
function shadow (level) {
    return lodash_2(shadows, level, shadows[0])
}
...
var DEFAULT_THEME = {
    ...
    colors: {
        primary:{
            lightest: "rgba(255, 160, 140, 1)",
            light: "rgba(235, 155, 130, 1)",
            medium: "rgba(200, 80, 50, 1)",
            dark: "rgba(160, 40, 20, 1)",
            darkest: "rgba(130, 20, 0, 1)",
        },
        secondary:{
            lightest: "rgba(140, 220, 255, 1)",
            light: "rgba(100, 180, 255, 1)",
            medium: "rgba(80, 140, 200, 1)",
            dark: "rgba(50, 100, 140, 1)",
            darkest: "rgba(30, 35, 90, 1)",
        },
        default:{
            lightest: "rgba(235, 247, 255, 1)",
            light: "rgba(220, 230, 240, 1)",
            medium: "rgba(100, 120, 140, 1)",
            dark: "rgba(40, 60, 80, 1)",
            darkest: "rgba(0, 20, 25, 1)",
        },
        success:{
            lightest: "rgba(200, 255, 200, 1)",
            light: "rgba(150, 230, 150, 1)",
            medium: "rgba(100, 200, 100, 1)",
            dark: "rgba(50, 150, 20, 1)",
            darkest: "rgba(30, 80, 10, 1)",
        },
        warning:{
            lightest: "rgba(255, 220, 180, 1)",
            light: "rgba(250, 215, 160, 1)",
            medium: "rgba(240, 190, 120, 1)",
            dark: "rgba(220, 170, 90, 1)",
            darkest: "rgba(200, 140, 80, 1)",
        },
        error:{
            lightest: "rgba(255, 220, 245, 1)",
            light: "rgba(245, 180, 230, 1)",
            medium: "rgba(225, 70, 130, 1)",
            dark: "rgba(200, 50, 115, 1)",
            darkest: "rgba(180, 0, 70, 1)",
        },
    },
    size: {
        base: "16px",
...
const getUnit = theme => lodash_2(theme, 'size.unit', 'rem');

const setUnits = theme => {
    const unit = getUnit(theme);
    for (var i = 0; i < UNIT_FIELDS.length; i++) {
        const field = UNIT_FIELDS[i];
        const value = lodash_2(theme, field, 0);
        lodash_3(theme, field, value + unit);
    }
};

const createTheme = (theme, defaultTheme=DEFAULT_THEME) => {
    const formatted = lodash_13(lodash_1(defaultTheme), lodash_1(theme));
