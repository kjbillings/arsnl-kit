...
const build = (tag, defaultAttrs={}) => (
    (configOrRender, configOrTrackers) => {
        ...
        if (isConfig(configOrTrackers)) {
            return r({
                ...defaultAttrs,
                ...resolveConfig(configOrTrackers),
...
export const button =      build('button', { type: 'button' })
...
export const svg =         build('svg', { preserveAspectRatio: "xMidYMid meet", viewBox: '0 0 32 32' })
